...
2. 执行如下命令进行CAModel性能仿真，仅提供关键参数项示例，其他参数请参考[Simulator仿真参数](./cannkit-cli-parameters.md)按需设置。
...
若开启[DumpTensor功能](./cannkit-commissioning-function-dumptensor.md)或[DumpAccChkPoint功能](./cannkit-commissioning-function-dumpaccchkpoint.md)，结果文件存放在dump目录下，详细结果介绍参见[产物说明](./cannkit-commissioning-function-dumptensor.md)。  
