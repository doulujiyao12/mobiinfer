...
![](https://media:401788444097299839)
...
![](https://media:401788444097332840)
...
![](https://media:401788444097371841)
...
![](https://media:401788444097403842)  

#### Cube编程范式

Cube计算的典型数据流图如下所示：

![](https://media:401788444097445843)
...
![](https://media:401788444097480844)
...
![](https://media:401788444097513845)

基于Matmul高阶API的融合算子编程范式，对上述数据流简化表达如下。

![](https://media:401788444097545846)
...
![](https://media:401788444097594847)  
...
![](https://media:401788444097638848)

由此可以看出，EnQue/DeQue主要解决了存在数据依赖时，并行执行单元的写后读同步控制问题。

![](https://media:401788444097668849)  
...
![](https://media:401788444097702850)

由此可以看出，AllocTensor/FreeTensor主要解决了存在数据依赖时，并行执行单元的读后写同步控制问题。

![](https://media:401788444097728851)
