...
#
# 与原 run_real_calib_1_W8A8.sh 的区别:
#   - 调用新脚本 run_visual_plugin_matmul_omc_v6110.sh (PLATFORM 默认 kirin9030, echo .om)
#   - 其余量化配置完全一致 (W8A8 / kirin9030 / DDK 6.1.1.0-complete)
#
...
#     -> run_visual_plugin_matmul_omc_v6110.sh (/temp/fdh/model_omc_fdh_9030/model_..._chunk_W8A8_{i}_real1_w8a8_v6110/)
...
ROUTE_SUFFIX=real1_w8a8_v6110    # route_dir 后缀 (独立, 避免覆盖原结果)
OM_COLLECT_DIR=${OMC_OUT_ROOT}/model_visual_plugin_matmul_W8A8_${ROUTE_SUFFIX}   # 汇总目录
OMC_SCRIPT=run_visual_plugin_matmul_omc_v6110.sh
# ====================================================================
...
echo "=========================================="
echo "  快速验证量化 (W8A8, 1 样本, DDK 6.1.1.0-complete)"
...
echo ""
echo "快速验证完成: 6 个 chunk 的 OM 已用 1 个校准样本 (W8A8, DDK 6.1.1.0-complete) 生成完毕。"
