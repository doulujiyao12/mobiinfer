...
# 用新 DDK 6.1.1.0-complete 的 omg 工具导出 OM 文件 (--target=om, 产物后缀 .om)
# 量化压缩用 quant_params_file (--compress_conf)
#
# 与原 run_visual_plugin_matmul_omc.sh 的区别:
#   - PLATFORM 默认 kirin9030 (原脚本默认 kirinx90)
#   - 末尾 echo 修正为 .om (原脚本误写 .omc)
#
# 用法: PLATFORM=kirin9030 bash run_visual_plugin_matmul_omc_v6110.sh <route_dir> [fp16|fp32]
...
WEIGHT_DTYPE=${2:-fp16}
# ---- 新 DDK 6.1.1.0-complete ----
OMG_TOOL=${OMG_TOOL:-/temp/fdh/ddk/DDK-tools-next-6.1.1.0-complete/tools/tools_omg/omg}
OMG_MASTER_DIR=${OMG_MASTER_DIR:-/temp/fdh/ddk/DDK-tools-next-6.1.1.0-complete/tools/tools_omg/master}
